...
//|                                                                  |
//+------------------------------------------------------------------+
bool CXGBoost::OnnxLoad(long &handle)
 {
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CXGBoost::Init(string onnx_filename, uint flags=ONNX_DEFAULT)
 {  
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CXGBoost::Init(const uchar &onnx_buff[], ulong flags=ONNX_DEFAULT)
 {  
...
void CXGBoost::PrintTypeInfo(const long num,const string layer,const OnnxTypeInfo& type_info)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
vector CXGBoost::predict_proba(const vector &x)
 {
   vector proba = {};
   if (!this.initialized)
    {
...
//|                                                                  |
//+------------------------------------------------------------------+
matrix CXGBoost::predict_proba(const matrix &x)
 {
   matrix preds = {};
...
//|                                                                  |
//+------------------------------------------------------------------+
vector CXGBoost::predict_bin(const matrix &x)
 {
   vector preds(x.Rows());
   for (ulong i=0; i<x.Rows(); i++)
     {
...
//|                                                                  |
//+------------------------------------------------------------------+
long CXGBoost::predict_bin(const vector &x)
 {
   if (!this.initialized)
    {
      printf("%s The model is not initialized yet to make predictions | call Init function first",__FUNCTION__);
